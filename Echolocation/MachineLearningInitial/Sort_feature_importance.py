...
csv_files_folder = os.path.join("Extracted features", "feature_importance")
...
for csv_file in os.listdir(csv_files_folder):
    if csv_file.endswith(".csv"):
        ...
        top_features = df['Feature'].head(10).tolist()
        bot_features = df['Feature'].tail(10).tolist()
...
sorted_top_importance_file = os.path.join("Extracted features", "sorted_top_feature_importance.csv")
sorted_bottom_importance_file = os.path.join("Extracted features", "sorted_bottom_feature_importance.csv")
